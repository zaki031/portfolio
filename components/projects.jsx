    ...
    <div className='mt-[50px] bg-[#231F1D] z-[1]'>
        ...
        <div className="grid grid-cols-1 gap-4 p-3 grid-cols-rows-3">
            ...
            <div className="bg-[#58555491]  duration-300 ease-out  shadow-md hover:-translate-y-1  p-4 rounded-md">
                ...
                <div className="flex gap-5">
                                    <a href="https://github.com/zaki031/Cryptito"><SiGithub className='hover:scale-[1.10] duration-300 ' /></a><a href="https://cryptito.vercel.app"><BsBoxArrowUpRight className='hover:scale-[1.10] duration-300 ' /></a>
...
<div className="bg-[#58555491]  duration-300 ease-out  shadow-md hover:-translate-y-1 p-4 rounded-md">
                ...
                <div className="flex gap-5">
                                    <a href="https://github.com/zaki031/7sky-s-restaurent"><SiGithub className='hover:scale-[1.10] duration-300 ' /></a><a href="https://7sky-s-restaurant.vercel.app"><BsBoxArrowUpRight className='hover:scale-[1.10] duration-300 ' /></a>
        ...
        <h1 className='text-4xl duration-300 ease-out   hover:-translate-y-1  font-bold text-[#E9E6D5] flex justify-end'><a className='flex gap-3' href="/projects">More projects <AiOutlineArrowRight className='hover:scale-[1.10] duration-300 '/></a> </h1>
